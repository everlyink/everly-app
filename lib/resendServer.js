      ...
      <tr>
        <td align="center">
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="520" style="max-width:520px;">
            <tr><td style="padding:8px 0 24px;font-family:Georgia,serif;color:#C0604A;font-size:20px;">everly</td></tr>
            <tr>
            ...
            <tr><td style="padding:24px 0 8px;font-family:Helvetica,Arial,sans-serif;font-size:12px;color:rgba(28,28,26,0.5);text-align:center;">everly · now in words. always in time. · everly.ink</td></tr>
          </table>
        </td>
      </tr>
    </table>
